...
function ChangesToTerms() {
    return (
        <div className='mt-10 lg:mt-16' id='changes-to-terms'>
            <h3 className='capitalize mb-4 font-medium md:font-semibold lg:text-2xl'>changes to terms</h3>
            <ol>
                <li className='text-sm lg:text-xl md:font-medium xl:leading-8 my-5'>
                    <span className='font-medium md:font-semibold'>Right to Change: </span>
                    {`We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material, we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion`}
                </li>
                <li className='text-sm lg:text-xl md:font-medium xl:leading-8 my-5'>
                    <span className='font-medium md:font-semibold'>Continuing to Use: </span>
