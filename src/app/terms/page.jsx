    ...
    return (
        <main className='mt-10 md:mt-16'>
            <div className="container mx-auto px-2 md:px-5">
                <h1 className='font-semibold text-lg lg:text-3xl'>Terms of Service</h1>
                ...
                <div className='mt-16 grid lg:grid-cols-3 lg:gap-10 xl:gap-12'>
                    <div className='lg:col-span-2 order-2 lg:order-1'>
                        ...
                        <div className='mt-10' id='acceptance-of-terms'>
                            <h3 className=' mb-4 font-semibold lg:text-2xl'>Acceptance of Terms</h3>
                ...
                <h3 className='font-semibold lg:text-2xl capitalize mt-7' id='accounts'>accounts</h3>
                <div className='mt-5'>
                    <p className='xl:text-xl font-medium xl:leading-8'><span className='font-semibold'>Account Creation: </span>
                        When you create an account with us, you must provide information that is accurate, complete, and current at all times. Failure to do so constitutes a breach of the Terms, which may result in immediate termination of your account on our Service
                    </p>
                </div>
                <div className='mt-5'>
                    <p className='xl:text-xl font-medium xl:leading-8'><span className='font-semibold'>Account Security: </span>
                ...
                <div className='mt-10 lg:mt-16' id='user-content'>
                    <h3 className='capitalize mb-4 font-semibold lg:text-2xl'>user content</h3>
                    <p className='xl:text-xl font-medium xl:leading-8'>
                ...
                <div className='mt-10 lg:mt-16' id='governing-law'>
                    <h3 className='capitalize mb-4 font-semibold lg:text-2xl'>governing law</h3>
                    <p className='xl:text-xl font-medium xl:leading-8'>
