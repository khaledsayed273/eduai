    ...
    return (
        <main className='mt-10 md:mt-16'>
            <div className="container mx-auto px-2 md:px-5">
                <h1 className='font-medium md:font-semibold text-lg lg:text-3xl'>Privacy Policy</h1>
                ...
                <div className='mt-16 grid lg:grid-cols-3 lg:gap-10 xl:gap-12'>
                    <div className='lg:col-span-2 order-2 lg:order-1'>
                        ...
                        <div className='mt-10 md:mt-16' id='introduction'>
                        ...
                        <div className='mt-10'>
                            <h3 className=' mb-4 font-medium md:font-semibold lg:text-2xl'>Information We Collect</h3>
                            <p className='text-sm lg:text-xl md:font-medium xl:leading-8'><span className='font-medium md:font-semibold'>Personal Data: </span>
                ...
                <div id="information-we-collect" className='mt-5'>
                    <p className='text-sm lg:text-xl md:font-medium xl:leading-8'><span className='font-medium md:font-semibold'>Derivative Data: </span>
                ...
                <div className='mt-5'>
                    <p className='text-sm lg:text-xl md:font-medium xl:leading-8'><span className='font-medium md:font-semibold'>Financial Data: </span>
                        Payment information such as credit card details, collected when you make transactions on the website.
                    </p>
                </div>
                <div className='mt-5'>
                    <p className='text-sm lg:text-xl md:font-medium xl:leading-8'><span className='font-medium md:font-semibold'>Data from Social Networks: </span>
                ...
                {data.map(section => (
                    <div className='mt-10 md:mt-16' id={section.id} key={section.id}>
                        <h3 className='capitalize mb-4 font-medium md:font-semibold lg:text-2xl'>{section.title}</h3>
                        <p className='text-sm lg:text-xl md:font-medium xl:leading-9'>{section.description}</p>
                    </div>
                ))}
